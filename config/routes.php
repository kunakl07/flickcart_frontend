...
Router::scope('/', function (RouteBuilder $routes) {
    ...
    $routes->connect('/cart', ['controller' => 'Cart', 'action' => 'view']);
    $routes->connect('/product/*', ['controller' => 'Products', 'action' => 'view']);
    $routes->connect('/comment', ['controller' => 'Products', 'action' => 'comment']);
    $routes->connect('/order', ['controller' => 'Orders', 'action' => 'view']);
    $routes->connect('/addresses', ['controller' => 'Addresses', 'action' => 'view']);
